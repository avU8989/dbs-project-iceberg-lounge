...
if(isset($_POST['delete_account'])){
    ...
    $person = $database->selectPersonIdFromCustomer($customerid);
    $database->deletePerson($person['PERSON_ID']);
/*
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-6">
                    <div class="text-center my-5">
                        <h1 class="display-5 fw-bolder text-white mb-2" style="text-align:center;"> Account wurde erfolgreich gelöscht.</h1>
